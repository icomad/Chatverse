var vNotify = (function () {
  ...
  var minimalDanger = function (params) {
    params.notifyClass = 'vnotify-minimal-danger';
    return addNotify(params);
  };
  var minimalSuccess = function (params) {
    params.notifyClass = 'vnotify-minimal-success';
    return addNotify(params);
  };
